...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 8555 or testnet: 18555)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8554 or testnet: 18554)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-paytxfee"))
    {
        ...
        if (nTransactionFee > 250 * PICO_COIN)
